 ...
 *
 * Every one of the 1,060 questions carries a `difficulty` of 1–3, and until now
 * it was read in exactly one place — `easyFirst`, for a self-declared beginner's
 * very first session. Everyone else got the whole bank shuffled by recency, so a
 * learner who had mastered a category kept meeting its easiest questions and one
 * who was drowning kept meeting its hardest.
 *
