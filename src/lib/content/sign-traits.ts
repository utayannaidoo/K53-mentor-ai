 ...
 *
 * Holds no question or flashcard content, so client surfaces can import it.
 */
 ...
 * need not stop if the way is clear", which matches /stop/ and would classify a
...
/** Meanings are safe for coarse flags no other sign's prose would carry. */
...
export function similarSigns(sign: RoadSign, pool: readonly RoadSign[], limit = 3): RoadSign[] {
