...
export const EXTRA_QUESTIONS: Question[] = [
  ...
  // ── MOTORCYCLE-SPECIFIC (Code A / A1) ───────────────────────
  {
    ...
    categoryId: "rules",
    codes: ["A"],
    prompt: "Riding a motorcycle in bright midday sunshine, your headlamp should be:",
    options: [
      "Off — lights are for night riding",
      "On — the headlamp stays on at all times while riding, day and night",
      "On only in rain or fog",
      "On only on freeways",
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "Brakes, tyres and load change your braking distance. Reaction distance is decided by your brain — and fatigue, alcohol and distraction all add unslowed metres before you even touch the pedal.",
    difficulty: 2,
    scope: "learners",
  },
  {
