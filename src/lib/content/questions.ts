...
import { INTERSECTIONS_PACK_QUESTIONS } from "./intersections-pack";
import { CONTROLS_PACK_QUESTIONS } from "./controls-pack";
...
import { CONTROLS_EXTRA_QUESTIONS } from "./controls-extra-pack";
import { CONTROLS_LIFT_QUESTIONS } from "./controls-lift-pack";
import { RULES_LIFT_QUESTIONS } from "./rules-lift-pack";
import { RULES_SPRINT_QUESTIONS } from "./rules-sprint-pack";
import { CONTROLS_SPRINT_QUESTIONS } from "./controls-sprint-pack";
import { CONTROLS_SYSTEMS_QUESTIONS } from "./controls-systems-pack";
import { RULES_LANE_QUESTIONS } from "./rules-lane-pack";
import { SIGNS_GUIDANCE_QUESTIONS } from "./signs-guidance-pack";
import { SIGNS_JUNCTIONS_QUESTIONS } from "./signs-junctions-pack";
import { RULES_EXTRA_QUESTIONS } from "./rules-extra-pack";
import { SIGNS_HAZARDS_QUESTIONS } from "./signs-hazards-pack";
import { GENERATED_SIGN_QUESTIONS } from "./signs-generated";
import { MOTUS_YARD_QUESTIONS } from "./motus-yard-pack";
import { MOTUS_SIGNS_QUESTIONS } from "./motus-signs-pack";
import { MOTUS_RULES_QUESTIONS } from "./motus-rules-pack";
...
export const QUESTIONS: Question[] = [...CORE_QUESTIONS, ...VEHICLE_QUESTIONS, ...EXTRA_QUESTIONS, ...VEHICLE_EXTRA_QUESTIONS, ...SIGNS_PACK_QUESTIONS, ...RULES_PACK_QUESTIONS, ...MARKINGS_PACK_QUESTIONS, ...INTERSECTIONS_PACK_QUESTIONS, ...CONTROLS_PACK_QUESTIONS, ...HPF_PACK_QUESTIONS, ...BIKE_HEAVY_PACK_QUESTIONS, ...CONVERTED_PACK_QUESTIONS, ...AARTO_PACK_QUESTIONS, ...CONTROLS_EXTRA_QUESTIONS, ...RULES_EXTRA_QUESTIONS, ...SIGNS_HAZARDS_QUESTIONS, ...CONTROLS_LIFT_QUESTIONS, ...RULES_LIFT_QUESTIONS, ...RULES_SPRINT_QUESTIONS, ...CONTROLS_SPRINT_QUESTIONS, ...CONTROLS_SYSTEMS_QUESTIONS, ...RULES_LANE_QUESTIONS, ...SIGNS_GUIDANCE_QUESTIONS, ...SIGNS_JUNCTIONS_QUESTIONS, ...GENERATED_SIGN_QUESTIONS, ...MOTUS_YARD_QUESTIONS, ...MOTUS_SIGNS_QUESTIONS, ...MOTUS_RULES_QUESTIONS];
