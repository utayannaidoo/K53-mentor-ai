 ...
 * began, so it beats account creation (a Google sign-in can predate the
 * wizard). Falls back through the first thing that proves they were here.
 */
...
/**
 * Whole days left in the free week — `FREE_TRIAL_DAYS` on day one, 0 once it
 * has run out. Paid tiers are never on a clock.
 */
