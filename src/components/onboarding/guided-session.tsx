          ...
          {step === 3 && (
            <div>
              <Paywall
                ...
                description={`You're at ${readiness.readiness}% readiness. Your free week runs this loop at a small daily size — Premium runs it at full volume, every day until you pass.`}
