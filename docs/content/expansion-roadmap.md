...
_**IOL mock-test review** (1 Aug 2026) shipped: +17 Q / +15 FC (`iol-mock-pack.ts`). Source: the [IOL Cape Argus mock test](https://iol.co.za/capeargus/news/2026-05-25-only-40-of-south-africans-pass-the-learners-licence-test--will-you-succeed/) (25 May 2026) — 192 questions across Code 1 / Code 8 / Code 10-14, extracted from the page's quiz payload. **The great majority were already covered**, which is the useful signal: a mature bank should absorb a competitor set with little new. **Their answer key is wrong in at least six places** (6 m rather than 9 m from a pedestrian crossing; 300 mm rather than 450 mm motorcycle side projection; a red flag from 600 mm rather than 300 mm; "both hands" on the handlebars rather than at least one; a de-restriction sign read as a compulsory speed; and a zebra-crossing question keyed to "accelerate past"), so every adopted item was re-derived from the regulation rather than copied — the corrections are tabulated in `facts/rules.md §IOL mock-test batch`. Adopted, all new to the bank: signal 30 m before a turn; reg 298A yellow-shoulder courtesy pass (daylight / single lane / 150 m visibility); 1,5 m from a fire hydrant; broken-beside-solid line; motorcycle load projections (600 mm front / 450 mm side), one-hand rule, no-towing; heavy width 2,6 m, length 12,5 m rigid / 22 m combination, rear-flag threshold, tare vs GVM, code EC age 18; dual air gauges, splitter, tachometer; axle-massload sign. Bank now **1 077 Q / 810 FC**._
